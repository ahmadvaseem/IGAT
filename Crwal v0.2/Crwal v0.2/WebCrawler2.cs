...
namespace Crwal_v0._2
{
    class WebCrawler2
    {
        ...
        Regex contains = new Regex("facebook|twitter|whatsapp|mailto|reddit|image");
        ...
        public void getPages()
        {
            ...
            string siteLink = "http://www.eurogamer.net/?type=review";
        ...
        public void getLinks(string url)
        {
            ...
            while (a != 10)
            {
                ...
                for (int i = 0; i < matches.Count; i++)
                {
                    ...
                    if (oMatch.Value.Contains("-review") && !contains.IsMatch(oMatch.Value))
                    {
                        ...
                        try
                        {
                            ...
                            if (m == '/')
                            {
                                ...
                                else
                                {
                                    ...
                                    _savingUrls.Add(mainLink + oMatch.Value);
                                }
