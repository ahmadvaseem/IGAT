<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AllGames.aspx.cs" Inherits="igat.com.AllGames" %>
...
<body>
  ...
  <div id="header">
    ...
    <!-- / Sort Navigation -->
        ...
        <div class="head">
            <div class="head-cnt"> 
                <div class="head-cnt"> <asp:Button class="view-all" id="Button1" Text="View All" runat="server" OnClick="btnRating_Click" />
        ...
        <asp:Repeater ID="rptGames" runat="server" OnItemCommand="rptGames_ItemCommand">
            ...
            <ItemTemplate>
                <div>
                   ...
                   <td><asp:Label ID="lblGameName" Text='<%# Eval("Name") %>' runat="server"></asp:Label></t> </td>
                   <td><div class="center"><asp:Button style='margin-left:100%;' ID="btnView" CommandName="View" runat="server" Text="View Rating"/> </div>  </td>
                            </tr>
                   </table>
                </div>
            </ItemTemplate>
