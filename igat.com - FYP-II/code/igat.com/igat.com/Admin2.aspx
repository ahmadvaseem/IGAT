<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Admin2.aspx.cs" Inherits="igat.com.Admin2" %>
...
<body>
  ...
  <div id="header">
    ...
    <div >    
        <asp:Label ID="Label1" runat="server" Text="Press to Start the complete Process"></asp:Label>
        </div>
        <div class="button">
        <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Enter" />
    </div>
        <asp:Label ID="dataAdded" runat="server" Text="Data Added" Visible="False"></asp:Label>
    </form>
</body>
</html>
